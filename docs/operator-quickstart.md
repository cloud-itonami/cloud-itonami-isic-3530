# Operator Quickstart — Community Steam and Air Conditioning Supply Distribution Operations

Shortest path from clone to a verified local dry-run for **ISIC 3530** (`cloud-itonami-isic-3530`).
...
- Blueprint governor key: `thermal-safety-governor`
- Likely source path: `steam.governor.cljc`
